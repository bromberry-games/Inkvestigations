...
<Card padding="xl">
  <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">5 messages</h5>
  <div class="flex items-baseline text-gray-900 dark:text-white">
    <span class="text-3xl font-semibold">$</span>
    <span class="text-5xl font-extrabold tracking-tight">4.99</span>
    <span class="ml-1 text-xl font-normal text-gray-500 dark:text-gray-400">one time</span>
  </div>
  <!-- List -->
