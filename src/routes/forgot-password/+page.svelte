<script lang="ts">
    import ForgotPassword from '$lib/flowbite-blocks/ForgotPassword.svelte';
    import ForgotPasswordHeader from '$lib/flowbite-blocks/ForgotPasswordHeader.svelte';
    import Section from '$lib/flowbite-blocks/Section.svelte';
