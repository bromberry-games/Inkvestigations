...
test('test create new mystery and publish it', async ({ page }) => {
	...
	await page
		.locator('textarea[name="suspects[0].description"]')
		.fill('A long-time butler and good friend of the family, loves the children.');
...
async function setSuspect(page: Page, index: number, name: string, description: string) {
	...
	await page.locator(`textarea[name="suspects[${index}].description"]`).fill(description);
...
test('Create prison and publish it', async ({ page }) => {
	...
	await page
		.locator('textarea[name="mystery.victim_description"]')
	...
	await page
		.locator('textarea[name="action_clues[0].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[1].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[2].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[3].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[4].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[5].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[6].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[7].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[8].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[9].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[10].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[11].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[12].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[13].clue"]')
		.fill(
	...
	await page.locator('textarea[name="action_clues[14].clue"]').fill('writing supplies tucked in mattress');
	await page.getByTestId('add-action').click();

	await page.locator('input[name="action_clues[15].action"]').fill('visitation rights denied');
	await page
		.locator('textarea[name="action_clues[15].clue"]')
	...
	await page
		.locator('textarea[name="action_clues[16].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="action_clues[17].clue"]')
		.fill(
	...
	await page
		.locator('textarea[name="few_shots_known_answers[0].answer"]')
		.fill(
	...
	await page
		.locator('textarea[name="few_shots_known_answers[1].answer"]')
		.fill(
	...
	await page
		.locator('textarea[name="few_shots_unknown_answers[0].answer"]')
		.fill(
	...
	await page
		.locator('textarea[name="few_shots_unknown_answers[1].answer"]')
	...
	await page.getByRole('button', { name: 'Submit' }).click();
	await expect(page.getByText('Mystery submitted')).toBeVisible();
});
